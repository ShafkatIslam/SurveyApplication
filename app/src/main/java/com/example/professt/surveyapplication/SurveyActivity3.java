...
public class SurveyActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SurveyActivity3.this,R.layout.sample_view,R.id.textViewId,userproduct); //creating object of ArrayAdapter....thre are 4 parameters in ArrayAdapter
        ...
        question = information.getQuestions().get(2);
        type = information.getTypes().get(2);
            ...
            public void onClick(View v) {
                if(type.equalsIgnoreCase("multiple choice"))
                {
                    try {
                        ...
                        information1.setQuestion3(question);
                        information1.setAnswer3(answer);
                        ...
                        Toast.makeText(SurveyActivity3.this,"Please select anything",Toast.LENGTH_SHORT).show();
                ...
                if(type.equalsIgnoreCase("dropdown"))
                {
                    ...
                    {
                        Toast.makeText(SurveyActivity3.this, "Please select from the drop down", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Information information1 = Information.getInstance();
                ...
                if(type.equalsIgnoreCase("Checkbox"))
                {
                    ...
                    else
                    {
                        ...
                        {
                            Toast.makeText(SurveyActivity3.this, "Please choose", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void getData() {
        ...
        Information information = Information.getInstance();
        String question = information.getQuestion3();
        String answer = information.getAnswer3();
