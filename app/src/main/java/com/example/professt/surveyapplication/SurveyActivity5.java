...
public class SurveyActivity5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SurveyActivity5.this,R.layout.sample_view,R.id.textViewId,userproduct); //creating object of ArrayAdapter....thre are 4 parameters in ArrayAdapter
        ...
        question = information.getQuestions().get(4);
        type = information.getTypes().get(4);
            ...
            public void onClick(View v) {
                if(type.equalsIgnoreCase("multiple choice"))
                {
                    try {
                        ...
                        information1.setQuestion5(question);
                        information1.setAnswer5(answer);

                        Intent intent = new Intent(SurveyActivity5.this,SubmitActivity.class);
                        startActivity(intent);

                    }
                    catch(Exception e){
                        Toast.makeText(SurveyActivity5.this,"Please select anything",Toast.LENGTH_SHORT).show();
                ...
                if(type.equalsIgnoreCase("dropdown"))
                {
                    ...
                    {
                        Toast.makeText(SurveyActivity5.this, "Please select from the drop down", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Information information1 = Information.getInstance();
                ...
                if(type.equalsIgnoreCase("Checkbox"))
                {
                    ...
                    else
                    {
                        ...
                        {
                            Toast.makeText(SurveyActivity5.this, "Please choose", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void getData() {
        ...
        Information information = Information.getInstance();
        String question = information.getQuestion5();
        String answer = information.getAnswer5();
