...
public class SurveyActivity2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(SurveyActivity2.this,R.layout.sample_view,R.id.textViewId,userproduct); //creating object of ArrayAdapter....thre are 4 parameters in ArrayAdapter
        ...
        question = information.getQuestions().get(1);
        type = information.getTypes().get(1);
            ...
            public void onClick(View v) {
                if(type.equalsIgnoreCase("multiple choice"))
                {
                    try {
                        ...
                        information1.setQuestion2(question);
                        information1.setAnswer2(answer);
                        ...
                        Toast.makeText(SurveyActivity2.this,"Please select anything",Toast.LENGTH_SHORT).show();
                ...
                if(type.equalsIgnoreCase("dropdown"))
                {
                    ...
                    {
                        Toast.makeText(SurveyActivity2.this, "Please select from the drop down", Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                        Information information1 = Information.getInstance();
                ...
                if(type.equalsIgnoreCase("Checkbox"))
                {
                    ...
                    else
                    {
                        ...
                        {
                            Toast.makeText(SurveyActivity2.this, "Please choose", Toast.LENGTH_SHORT).show();
                        }
                    }
    ...
    private void getData() {
        ...
        Information information = Information.getInstance();
        String question = information.getQuestion2();
        String answer = information.getAnswer2();
